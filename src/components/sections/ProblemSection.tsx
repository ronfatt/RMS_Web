        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="p-8 rounded-2xl bg-slate-950 border border-slate-800 space-y-6">
            <div>
              ...
              <h3 className="text-xl font-bold text-slate-200">仅靠社交媒体 (FB / IG / TikTok)</h3>
            </div>
            
            <ul className="space-y-4 text-xs sm:text-sm text-slate-400">
              <li className="flex items-start gap-3">
                <XCircle className="w-4 h-4 text-slate-500 shrink-0 mt-0.5" />
                <span><strong className="text-slate-300">信息分散难以查找：</strong> 客户想找菜单、价目或案例，要在几十条帖文中下滑。</span>
              </li>
              <li className="flex items-start gap-3">
                <XCircle className="w-4 h-4 text-slate-500 shrink-0 mt-0.5" />
                <span><strong className="text-slate-300">算法规则多变：</strong> 无法 100% 沉淀自己的独立客户流量资产。</span>
              </li>
              <li className="flex items-start gap-3">
                <XCircle className="w-4 h-4 text-slate-500 shrink-0 mt-0.5" />
                <span><strong className="text-slate-300">Google 搜寻不到：</strong> 客户在谷歌搜索您的行业或公司名时，查不到正式官网。</span>
              </li>
              <li className="flex items-start gap-3">
                <XCircle className="w-4 h-4 text-slate-500 shrink-0 mt-0.5" />
                <span><strong className="text-slate-300">单价无法拉高：</strong> 缺乏商务信任背书，面对大单客户容易处于被动。</span>
              </li>
            </ul>
          </div>

          {/* Social Media + Owned Website */}
          <div className="p-8 rounded-2xl bg-slate-900 border border-slate-700 space-y-6 shadow-xl">
            <div>
              <span className="text-[10px] font-bold uppercase tracking-widest text-indigo-400 block mb-1">
                RECOMMENDED STRATEGY
              </span>
              <h3 className="text-xl font-bold text-white">社交媒体 + 专属专业官网</h3>
            </div>
