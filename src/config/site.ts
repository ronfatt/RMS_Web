...
export const siteConfig: SiteConfig = {
  ...
  portfolioItems: [
    // --- LIVE CLIENT PROJECTS (5 ITEMS) ---
    {
      ...
      title: "Sin Ban Hock Motor",
      category: "automotive",
      categoryZh: "摩托车经销 / 车辆销售",
      categoryEn: "Motorcycle Dealership & Sales",
      categoryBm: "Pengedar Motosikal & Jualan",
      description: "Official website for Sin Ban Hock Motor Dealership, showcasing new motorcycle models, loan installment plans, and sales inquiries.",
      badgeText: "CLIENT WORK",
      tags: ["Motorcycle Dealer", "Motor Sales", "Loan Installment"],
