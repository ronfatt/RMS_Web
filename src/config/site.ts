...
export const siteConfig: SiteConfig = {
  ...
  // AUTHENTIC REAL CLIENT PORTFOLIO SHOWCASE
  portfolioItems: [
    {
  ...
  faqItems: [
    ...
    },
    {
      ...
      answer: "Absolutely not! Check out our featured live client projects (Sin Ban Hock, Treast Band, Enhance Feng Shui, BICC, Ron Meraki Studio). We adhere to high-end minimalist agency standards for all projects.",
    },
  ],
